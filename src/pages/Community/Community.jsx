          ...
          >
            ...
            >
              ...
              <div className="p-6 overflow-y-auto max-h-[75vh]">
                ...
                />
                <div
                  className="prose prose-cyan max-w-none mb-6 leading-relaxed text-gray-700"
                ...
                <div className="flex items-center justify-between mt-6 border-t pt-4 border-cyan-100">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-[#11c3c0] font-semibold hover:text-[#3ea1f1] transition"
                  >
                    <Heart
                      className={`w-5 h-5 ${likedPosts.has(selectedPost.id) ? "fill-[#11c3c0]" : ""
                        }`}
                    />
