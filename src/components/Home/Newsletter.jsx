...
const Newsletter = () => {  
  return (
    <div className="relative z-5  mb-10 mt-10 flex flex-col items-center justify-center px-6">
      <div className="bg-white shadow-md border-1 border-[#11c3c0] rounded-2xl px-8 py-10 max-w-4xl w-full text-center -mb-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          <input
            ...
            className="flex-1 w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3ea1f1]"
          />
