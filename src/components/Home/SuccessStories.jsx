...
const SuccessStories = () => {
  ...
  useEffect(() => {
    const fetchStories = async () => {
      const res = await axios.get("https://nomad-atlas-server-delta.vercel.app/api/success-stories");
      setStories(res.data);
    };
    fetchStories();
  }, []);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axios.post("https://nomad-atlas-server-delta.vercel.app/api/success-stories", formData);
    setFormData({
      name: "",
      role: "",
      location: "",
