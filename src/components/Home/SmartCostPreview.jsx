...
const SmartCostPreview = () => {
  ...
  return (
    <div className="mx-5 md:mx-10 lg:mx-20  px-4 py-10">
      <h1 className=" text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-2 text-gray-800">
      ...
      <div className="mb-8 max-w-md mx-auto">
        ...
        <input
          ...
          className="w-full border rounded-lg px-4 py-3 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white"
        />
      </div>
