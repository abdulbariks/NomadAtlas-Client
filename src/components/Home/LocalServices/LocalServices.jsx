...
const LocalServices = () => {
  return (
    <section className=" mt-15 px-5 md:px-8 lg:px-10  ">
      ...
      >
        <button className="inline-flex items-center gap-2 px-6 py-3 bg-[#11c3c0] text-white rounded-full font-medium shadow-sm hover:bg-[#3ea1f1] transition-all duration-300">
