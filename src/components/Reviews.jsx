            ...
            <section className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-5 mb-16 items-center lg:items-stretch justify-center px-4">
                ...
                <div className="flex flex-col w-full max-w-lg p-6 mx-auto bg-gray-100 rounded-lg shadow-sm">
                    ...
                    <div className="pt-4 space-y-2 text-sm text-gray-700">
                        <p>NomadAtlas helped me find the perfect city with affordable living costs and reliable Wi-Fi.</p>
                        <p>Now I can work remotely without worrying about poor connections or high expenses.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col w-full max-w-lg p-6 mx-auto bg-gray-100 rounded-lg shadow-sm">
                    ...
                    <div className="pt-4 space-y-2 text-sm text-gray-700">
                        <p>I loved the coworking space recommendations. They were accurate and super helpful while traveling.</p>
                        <p>A few cities need more updated cost data, but overall very useful!</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col w-full max-w-lg p-6 mx-auto bg-gray-100 rounded-lg shadow-sm">
                    ...
                    <div className="pt-4 space-y-2 text-sm text-gray-700">
                        <p>The cost of living comparison feature is a life-saver. Helped me plan my budget in advance.</p>
