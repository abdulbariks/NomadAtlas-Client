      ...
      <div className="mx-auto px-8 pb-12 pt-25 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4 text-gray-500">
            <a href="https://www.facebook.com/" aria-label="Facebook" className="hover:text-[#3ea1f1] transition">
            ...
            <a href="https://x.com/home" aria-label="Twitter" className="hover:text-[#11c3c0] transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/" aria-label="Instagram" className="hover:text-[#3ea1f1] transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/feed/" aria-label="LinkedIn" className="hover:text-[#11c3c0] transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
